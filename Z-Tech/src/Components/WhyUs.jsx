...
import WhyUsDark from './WhyUsDark'
...
export default function WhyUs() {
  ...
  return (
    <div>
      ...
      {
         theme ==="light"?  <div className='overflow-y-hidden'>
         <div className="xl:mx-auto xl:container  xl:px-20 md:px-6 px-4 py-12">
           <div className="lg:flex items-center justify-center lg:space-x-12 2xl:space-x-6">
             <div >
               <p className="lg:text-4xl text-3xl font-extrabold leading-9 text-indigo-700 w-fit mx-auto">Why choose us</p>
               ...
               <div className="mt-6 md:mt-10 grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 lg:mt-6 2xl:mt-12">
                 <div className="flex items-center">
                   ...
                   <div className="flex items-start flex-col ml-6 pt-8">
                     ...
                     <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">Online website and fast delivery save your time .</p>
                   </div>
                 </div>
                 <div className="flex items-center">
                   <div className="w-16 h-16 relative">
                   ...
                   <div className="flex items-start flex-col ml-6 pt-8">
                     ...
                     <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">User Friendly website for find a product.</p>
                   </div>
                 </div>
                 <div className="flex items-center">
                   <div className="w-16 h-16 relative">
                   ...
                   <div className="flex items-start flex-col ml-6 pt-8">
                     <h2 className="text-lg font-semibold leading-4 text-gray-800">All Update Products</h2>
                     <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">You will find all Update product.</p>
                   </div>
                 </div>
                 <div className="flex items-center">
                   <div className="w-16 h-16 relative">
                   ...
                   <div className="flex items-start flex-col ml-6 pt-8">
                     ...
                     <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">Ph best seller award 2022.</p>
                   </div>
                 </div>
               </div>
             </div>
